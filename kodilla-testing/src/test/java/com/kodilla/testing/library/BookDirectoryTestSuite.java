...
public class BookDirectoryTestSuite {
    ...
    @Test
    public void zeroBooksBorrowed() {
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser user1 = new LibraryUser("John", "Smith", "12345678912");
    ...
    public void oneBookBorrowed() {
        ...
        //When
        List<Book> theListOfBook1 = bookLibrary.listBooksInHandsOf(user1);
        //Then
        assertEquals(1, theListOfBook1.size());
    }

    @Test
    public void fiveBooksBorrowed() {
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser user1 = new LibraryUser("John", "Smith", "12345678912");
        ...
        //When
        List<Book> theListOfBook5 = bookLibrary.listBooksInHandsOf(user1);
        //Then
